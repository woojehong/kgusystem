...
function DiscordIcon({ size = 16 }) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} fill="#5865F2" aria-hidden="true">
...
function BasicTab({ onClose }) {
  ...
  return (
    <div className="space-y-5">
      ...
      {/* 디스코드 연동 */}
      <div className="p-3 rounded-xl bg-base-850 border border-base-700 space-y-2.5">
        ...
        {profile.discordId && (
          <div
            ...
            style={{ background: 'rgba(88,101,242,0.15)', border: '1px solid rgba(88,101,242,0.45)' }}
          >
            <DiscordIcon size={22} />
            <div className="min-w-0">
              <p className="text-[11px] font-bold" style={{ color: '#aab4ff' }}>디스코드 계정 연동됨</p>
              <p className="text-sm font-bold text-white truncate">{profile.discordName || profile.discordId}</p>
            </div>
          </div>
        )}
